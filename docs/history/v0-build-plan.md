> **Historical record, not binding.** This is the v0 build plan from July 2026, kept
> for provenance. It was moved here from the repo root on 2026-09-25. The current plan
> is [PLAN.md](../../PLAN.md). Where this file says "binding", read "was binding
> during the v0 build".
